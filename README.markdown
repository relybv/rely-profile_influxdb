...
4. [Setup - The basics of getting started with profile_influxdb](#setup)
    * [What profile_influxdb affects](#what-profile_influxdb-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with profile_influxdb](#beginning-with-profile_influxdb)
...
### Beginning with profile_influxdb
