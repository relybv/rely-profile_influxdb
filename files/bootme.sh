...
#
# Usage:
# Ubuntu / Debian: wget https://raw.githubusercontent.com/relybv/dirict-profile_influxdb/master/files/bootme.sh; bash bootme.sh
#
# Red Hat / CentOS: curl https://raw.githubusercontent.com/relybv/dirict-profile_influxdb/master/files/bootme.sh -o bootme.sh; bash bootme.sh
...
if [ -d /root/profile_influxdb ]; then
  ...
  echo "Cloning repo"
  git clone https://github.com/relybv/dirict-profile_influxdb.git /root/profile_influxdb
  cd /root/profile_influxdb
fi
